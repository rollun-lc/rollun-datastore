...
| GET | nan | DownloadCsvHandler | GET /?rql | any | Obtaining datastore content in CSV format<br>Header will be changed to standarst (text/csv) in next releases. | - HEADER = 'download'<br>- limit in rql will be changed by server - you'll get all the content of DataStore |
