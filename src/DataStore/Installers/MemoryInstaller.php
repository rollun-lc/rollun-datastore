...
class MemoryInstaller extends InstallerAbstract
{
    ...
    public function getDescription($lang = "en")
    {
        switch ($lang) {
            case "ru":
                $description = "Позволяет представить массив в качестве хранилища.";
                break;
            default:
    ...
    public function isInstall()
    {
        ...
        return (isset($config['services']['abstract_factories']) &&
            in_array(MemoryAbstractFactory::class, $config['services']['abstract_factories']));
    }
}
