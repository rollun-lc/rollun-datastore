...
interface DataStoreInterface extends ReadInterface
{
     ...
     * - if primary key is not specified, it should be autogenerated on application level;
    ...
    /**
     * Create new records:
     * - if primary keys is not specified, its should be autogenerated on application level;
     * - if regular record exist or can't be created it should be pass it and start create next one;
     * - method should return list of created primary keys.
     *
     ...
     * - primary key is required, in other key it should throw exception;
     ...
     * - primary keys are required, in other case it should throw exception;
     ...
     * - if primary key specified in record it should throw exception
    ...
    /**
     * Delete record by primary key in data store.
    ...
    /**
     * Delete all records. Actually this method should empty data store.
     * It should return list of primary key of deleted records.
     *
     * @return array
     */
