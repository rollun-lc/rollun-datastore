...
use rollun\datastore\Rql\TokenParser\Query\Basic\ScalarOperator\LikeGlobTokenParser;
use Xiag\Rql\Parser\ExpressionParser;
use Xiag\Rql\Parser\Parser;
use Xiag\Rql\Parser\Token;
use Xiag\Rql\Parser\TokenStream;

class LikeGlobTokenParserTest extends TestCase
{
    protected function createObject()
    {
        return new LikeGlobTokenParser();
    }
    ...
    public function testParse()
    {
        ...
        /** @var LikeGlobTokenParser|PHPUnit_Framework_MockObject_MockObject $object */
        ...
        $tokenStream
            ...
            ->method('expect')
            ->with($this->equalTo(Token::T_OPERATOR), $this->equalTo('like'))
        ...
        $node = new LikeGlobNode($field, $value);
