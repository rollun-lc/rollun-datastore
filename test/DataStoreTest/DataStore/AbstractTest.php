...
abstract class AbstractTest extends TestCase
{
    ...
    {
        $this->_initObject();
        $this->assertEquals('id', $this->object->getIdentifier());
    }
    ...
    {
        $this->_initObject();
        $this->assertEquals($this->_itemsArrayDelault[2 - 1], $this->object->read(2));

        $this->assertEquals($this->_itemsArrayDelault['1'], $this->object->read('2'));
    }
    ...
    public function testCreate_withoutId()
    {
        ...
        $this->assertEquals('Create_withoutId_', $insertedItem['fString']);
        $this->assertEquals(1000.01, $insertedItem['fFloat']);
    }
    ...
    public function testCreate_withtId()
    {
        ...
        $id = $newItem['id'];
        $insertedItem = $this->object->read($id);
        $this->assertEquals('Create_withId', $insertedItem['fString']);
    ...
    public function testCreate_withtIdRewrite()
    {
        ...
        $id = $newItem['id'];
        $insertedItem = $this->object->read($id);
        $this->assertEquals('Create_withtIdRewrite', $insertedItem['fString']);
    ...
    public function testUpdate_withtId_WhichPresent()
    {
        ...
        $this->assertEquals(40, $item['anotherId']);
        $this->assertEquals('withtId_WhichPresent', $item['fString']);
        $this->assertEquals(['id' => 3, 'anotherId' => 40, 'fString' => 'withtId_WhichPresent', 'fFloat' => 300.003],
            $row);
    }
    ...
    public function testUpdate_withtIdwhichAbsent_ButCreateIfAbsent_True()
    {
        ...
        $this->assertEquals('withtIdwhichAbsent', $item['fString']);
        unset($row['anotherId']);
        $this->assertEquals([
            'id' => 1000,
            'fFloat' => 1000.01,
    ...
    public function testDelete_withtId_WhichPresent()
    {
        ...
        $this->assertNull($this->object->read(4));
    }
    ...
    public function testIteratorInterfaceStepToStep()
    {
        ...
        foreach ($this->object as $key => $value) {
            ...
            $this->assertEquals($this->_itemsArrayDelault[$key - 1], $value);
    ...
    public function test_QueryNe()
    {
        $this->_initObject();
        $query = new Query();
        $eqNode = new ScalarOperator\NeNode('fString', 'val2');
        $query->setQuery($eqNode);

        $this->assertEquals(1, count($this->object->query($query)));
    }
    ...
    public function test_QueryAndNode()
    {
        ...
        $this->assertEquals($this->_itemsArrayDelault[1], $this->object->query($query)[0]);
    }
    ...
    public function testQuery_Empty()
    {
        $this->_initObject();
        $query = new Query();
        $eqNode = new ScalarOperator\EqNode('fString', 'not_exist_value');
        $query->setQuery($eqNode);
        $this->assertEquals([], $this->object->query($query));
    }
    ...
    public function testQuery_all()
    {
        ...
        for ($index = 0; $index < count($this->_itemsArrayDelault); $index++) {
            $this->assertEquals(array_pop($this->_itemsArrayDelault), array_pop($queryArray));
        }
    }
    ...
    public function testQuery_orderAnotherId()
    {
        ...
        $query->setSort($sortNode);
        $queryArray = $this->object->query($query);
        $this->assertEquals(array_pop($this->_itemsArrayDelault), $queryArray[3 - 1]);
        $this->assertEquals(array_pop($this->_itemsArrayDelault), $queryArray[4 - 1]);
    }
    ...
    public function testQuery_orderDesc()
    {
        ...
        $query->setSort($sortNode);
        $queryArray = $this->object->query($query);
        $this->assertEquals($this->_itemsArrayDelault[1 - 1], $queryArray[4 - 1]);
        $this->assertEquals($this->_itemsArrayDelault[2 - 1], $queryArray[3 - 1]);
    }
    ...
    public function testQuery_orderCombo()
    {
        ...
        $query->setSort($sortNode);
        $queryArray = $this->object->query($query);
        $this->assertEquals($this->_itemsArrayDelault[4 - 1], $queryArray[1 - 1]);
        $this->assertEquals($this->_itemsArrayDelault[3 - 1], $queryArray[2 - 1]);
        $this->assertEquals($this->_itemsArrayDelault[1 - 1], $queryArray[4 - 1]);
    }
    ...
    public function testQuery_WhereId()
    {
        $this->_initObject();
        $query = new Query();
        $eqNode = new ScalarOperator\EqNode('id', 2);
        $query->setQuery($eqNode);
        $queryArray = $this->object->query($query);
        $this->assertEquals($this->_itemsArrayDelault[2 - 1], $queryArray[1 - 1]);
        $this->assertEquals(1, count($queryArray));
    }
    ...
    public function testQuery_WhereCombo()
    {
        ...
        $eqNode2 = new ScalarOperator\EqNode('fFloat', 300.003);
    ...
    public function testQuery_fieldsCombo()
    {
        ...
        $queryArray = $this->object->query($query);
        $this->assertEquals(['fFloat' => $this->_itemsArrayDelault[2 - 1]['fFloat']], $queryArray[1 - 1]);
        $this->assertEquals(2, count($queryArray));
    }
    ...
    public function testQuery_limitOffsetCombo()
    {
        ...
        $query->setLimit($limitNode);
        $queryArray = $this->object->query($query);
        $this->assertEquals(['fFloat' => $this->_itemsArrayDelault[3 - 1]['fFloat']], $queryArray[1 - 1]);
        $this->assertEquals(['fFloat' => $this->_itemsArrayDelault[4 - 1]['fFloat']], $queryArray[2 - 1]);
        $this->assertEquals(2, count($queryArray));
    }
    ...
    public function testQuery_Where_Like_True($globString, $arrayDelaultKeys, $count)
    {
        ...
        if (!empty($queryArray) && $arrayDelaultKeys > 0) {
            $this->assertEquals($this->_itemsArrayDelault[$arrayDelaultKeys - 1], $queryArray[1 - 1]);
        }
        $this->assertEquals($count, count($queryArray));
    }
