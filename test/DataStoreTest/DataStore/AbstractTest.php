...
// *************************** Item **************************************************
    ...
    public function testUpdate_withtIdwhichAbsent_ButCreateIfAbsent_True()
    {
        ...
        Assert::assertTrue($isDeprecated, "Method not trigger deprecated error.");
    }
...
//************************** RQL ************************
    ...
    public function test_multiplyCreate()
    {
        $initItems = [['id' => '010', 'anotherId' => 0, 'fString' => 'val1', 'fFloat' => 0.0]];
        $this->_initObject($initItems);
        Assert::assertEquals($initItems, $this->object->query(new Query()));
        $createdItems = $this->object->multiCreate($this->_itemsArrayDelault);
        Assert::assertEquals($createdItems, $this->_itemsArrayDelault); //data is created eq data from query
    }
    ...
    public function test_queryUpdate()
    {
        ...
        $query = new Query();
        $query->setQuery(new ScalarOperator\EqNode("fString", "val3"));
        $data = $this->object->query($query);
